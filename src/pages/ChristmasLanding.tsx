...
export default function ChristmasLanding() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-100 to-green-100 dark:from-rose-950/30 dark:to-green-950/30">
            ...
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <Link to="/find-sitters?season=christmas">
                  <Button size="lg" className="h-14 px-8 text-lg font-bold bg-rose-600 hover:bg-rose-700 shadow-2xl">
                    🎁 Find Your Christmas Sitter
                  </Button>
                </Link>
                <Link to="/how-it-works">
                  <Button size="lg" variant="outline" className="h-14 px-8 text-lg font-semibold border-2 border-rose-300 dark:border-rose-700">
                    How It Works
                  </Button>
                </Link>
              </div>
      ...
      {/* Trust Signals */}
      <section className="py-12 bg-gradient-to-r from-rose-50 to-green-50 dark:from-rose-950/10 dark:to-green-950/10 border-y border-rose-100 dark:border-rose-900">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="text-center">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-rose-600 text-white mb-3 shadow-lg">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              Why Book Your Christmas Sitter <span className="text-rose-600">Early?</span>
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <Card key={i} className="border-2 border-rose-200 dark:border-rose-900 hover:shadow-xl transition-shadow">
      ...
      {/* What's Included */}
      <section className="py-20 bg-gradient-to-br from-green-50 to-rose-50 dark:from-green-950/10 dark:to-rose-950/10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              What Your Pet Gets This <span className="text-green-600">Christmas</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-6 bg-background rounded-xl border-2 border-green-200 dark:border-green-900 hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              Book in <span className="text-rose-600">3 Simple Steps</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={step.num} className="flex gap-6 items-start">
                  <div className="flex-shrink-0 w-16 h-16 rounded-full bg-rose-600 text-white flex items-center justify-center text-2xl font-bold shadow-xl">
                    {step.num}
                  </div>
                  <div className="pt-3">
            ...
            <div className="mt-12 text-center">
              <Link to="/find-sitters">
                <Button size="lg" className="h-14 px-8 text-lg font-bold bg-green-600 hover:bg-green-700">
                  Start Your Search 🎅
                </Button>
              </Link>
            </div>
      ...
      {/* Testimonials */}
      <section className="py-20 bg-gradient-to-br from-rose-50 to-green-50 dark:from-rose-950/10 dark:to-green-950/10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              What Pet Parents Say About Their <span className="text-green-600">Christmas Bookings</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              Christmas Booking <span className="text-rose-600">FAQs</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
            ...
            <div className="space-y-4">
              {[
                ...
                <Card key={i} className="border-2 border-rose-200 dark:border-rose-900">
                  <CardContent className="p-6">
