...
export default function ChristmasLanding() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-red-50 via-background to-emerald-50 dark:from-red-950/20 dark:via-background dark:to-emerald-950/20">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <div className="absolute -top-20 -left-10 w-96 h-96 rounded-full bg-red-300/30 dark:bg-red-700/20 blur-3xl" />
          <div className="absolute top-1/3 right-0 w-[500px] h-[500px] rounded-full bg-emerald-300/30 dark:bg-emerald-700/20 blur-3xl" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-96 rounded-full bg-red-400/20 dark:bg-red-600/15 blur-3xl" />
        </div>

        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 rounded-full bg-red-100 dark:bg-red-900/30 px-4 py-2 text-sm font-semibold shadow-sm mb-6 border-2 border-red-200 dark:border-red-800">
                <span>🎅 Christmas bookings now open</span>
                <span className="text-xs rounded-full bg-red-500 text-white px-2 py-0.5 font-bold animate-pulse">
                  Limited spots!
                </span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold leading-tight mb-6">
                <span className="bg-gradient-to-r from-red-600 via-emerald-600 to-red-600 bg-clip-text text-transparent">
                  Your Pet&apos;s Perfect
                </span>
                <br />
                <span className="bg-gradient-to-r from-emerald-600 via-red-600 to-emerald-600 bg-clip-text text-transparent">
                  Christmas Holiday 🎄
                </span>
              </h1>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4">
                <Link to="/find-sitters?season=christmas">
                  <Button size="lg" className="h-14 px-8 text-lg font-bold bg-gradient-to-r from-red-600 to-emerald-600 hover:from-red-700 hover:to-emerald-700 shadow-2xl">
                    🎁 Find Your Christmas Sitter
                  </Button>
                </Link>
                <Link to="/how-it-works">
                  <Button size="lg" variant="outline" className="h-14 px-8 text-lg font-semibold border-2 border-red-300 dark:border-red-700">
                    How It Works
                  </Button>
                </Link>
              </div>
      ...
      {/* Trust Signals */}
      <section className="py-12 bg-gradient-to-r from-red-50 to-emerald-50 dark:from-red-950/10 dark:to-emerald-950/10 border-y border-red-100 dark:border-red-900">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="text-center">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-red-500 to-emerald-500 text-white mb-3 shadow-lg">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <Card key={i} className="border-2 border-red-100 dark:border-red-900 hover:shadow-xl transition-shadow">
      ...
      {/* What's Included */}
      <section className="py-20 bg-gradient-to-br from-emerald-50 via-background to-red-50 dark:from-emerald-950/10 dark:via-background dark:to-red-950/10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              What Your Pet Gets This <span className="text-emerald-600">Christmas</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-6 bg-background rounded-xl border-2 border-emerald-100 dark:border-emerald-900 hover:shadow-lg transition-shadow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={step.num} className="flex gap-6 items-start">
                  <div className="flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-emerald-500 text-white flex items-center justify-center text-2xl font-bold shadow-xl">
                    {step.num}
                  </div>
                  <div className="pt-3">
            ...
            <div className="mt-12 text-center">
              <Link to="/find-sitters">
                <Button size="lg" className="h-14 px-8 text-lg font-bold bg-gradient-to-r from-emerald-600 to-red-600 hover:from-emerald-700 hover:to-red-700">
                  Start Your Search 🎅
                </Button>
              </Link>
            </div>
      ...
      {/* Testimonials */}
      <section className="py-20 bg-gradient-to-br from-red-50 via-background to-emerald-50 dark:from-red-950/10 dark:via-background dark:to-emerald-950/10">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
              What Pet Parents Say About Their <span className="text-emerald-600">Christmas Bookings</span>
            </h2>
            <p className="text-center text-muted-foreground mb-12 text-lg">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <Card key={i} className="border-2 border-emerald-100 dark:border-emerald-900">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                <Card key={i} className="border-2 border-red-100 dark:border-red-900">
                  <CardContent className="p-6">
      ...
      {/* Final CTA */}
      <section className="py-20 bg-gradient-to-r from-red-600 to-emerald-600 text-white relative overflow-hidden">
