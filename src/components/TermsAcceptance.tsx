...
export default function TermsAcceptance({ isOpen, onAccept, onDecline }: TermsAcceptanceProps) {
  ...
  return (
    ...
    >
      <div
        className="relative max-w-2xl w-[92%] sm:w-full max-h-[90vh] flex flex-col border-2 border-purple-200 dark:border-purple-800 shadow-2xl overflow-hidden bg-background rounded-xl"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Decorative Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-purple-950/20 dark:via-blue-950/20 dark:to-indigo-950/20 opacity-60 -z-10" />
        <div className="absolute top-0 right-0 w-32 h-32 bg-purple-300 dark:bg-purple-700 rounded-full blur-3xl opacity-25 -z-10" />
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-300 dark:bg-blue-700 rounded-full blur-3xl opacity-25 -z-10" />

        {/* Header */}
        <header className="flex items-center justify-between px-6 pt-5 pb-3 border-b border-purple-200 dark:border-purple-800">
        ...
        {/* Scrollable body */}
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4 bg-white/50 dark:bg-gray-900/50 rounded-t-none backdrop-blur">
        ...
        {/* Footer */}
        <div className="space-y-4 px-6 pb-5 pt-4 border-t border-purple-200 dark:border-purple-800 bg-background/80">
