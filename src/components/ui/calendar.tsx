  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground w-12 h-12 flex items-center justify-center font-semibold text-sm uppercase",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-12 w-12 p-0 font-medium aria-selected:opacity-100 text-base"),
