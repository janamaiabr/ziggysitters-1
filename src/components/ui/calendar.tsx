  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground flex-1 font-semibold text-sm uppercase flex items-center justify-center h-10",
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-10 w-full p-0 font-medium aria-selected:opacity-100 text-base"),
