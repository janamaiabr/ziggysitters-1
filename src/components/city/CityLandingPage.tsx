        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg border border-border mb-8 aspect-[16/7]">
            <iframe
              ...
              src={"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100000!2d0!3d0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2s" + encodeURIComponent(city.name + ", " + countryName) + "!5e0!3m2!1sen!2snz!4v1"}
