      ...
      <div className="container mx-auto px-4 h-14 md:h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          {user && profile?.role === 'pet_sitter' && (
            <Link to="/calendar" className="text-sm font-medium hover:text-primary transition-colors flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-primary/10 text-primary">
