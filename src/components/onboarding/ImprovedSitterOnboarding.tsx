          ...
          <CardContent className="space-y-6">
            <Alert className="bg-green-50 border-green-200">
              ...
              <AlertDescription className="text-green-900">
                Great work! You've completed all the required steps. Review your information and submit for admin approval.
              </AlertDescription>
            </Alert>

            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <span className="font-medium">Experience & Bio</span>
              ...
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <span className="font-medium">Calendar Setup</span>
                <CheckCircle2 className="w-5 h-5 text-green-600" />
              </div>
              
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <span className="font-medium">Verification Documents</span>
                {(idDocumentUrl || blueCardUrl) ? (
                  <CheckCircle2 className="w-5 h-5 text-green-600" />
                ) : (
                  <AlertCircle className="w-5 h-5 text-destructive" />
                )}
            ...
            <Alert>
              <AlertDescription>
                ...
                <br />
                Our admin team will review your profile and documents. You'll receive an email within 1-2 business days with the outcome. Once approved, you'll be visible to pet owners and can start accepting bookings!
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
