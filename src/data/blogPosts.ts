...
export const blogPosts: BlogPostData[] = [
  ...
  // Subsequent new blog posts would continue here...
  
  // Previous existing posts would follow (the ones from the original file)
  {
    slug: 'ultimate-guide-pet-sitting-auckland',
    title: 'The Ultimate Guide to Pet Sitting in Auckland (2026)',
    // ... (rest of the original first post)
  },
  // Add the rest of the previous posts here...
] as const;