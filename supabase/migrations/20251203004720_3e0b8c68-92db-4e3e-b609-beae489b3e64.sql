-- Schedule daily check for incomplete onboarding (runs at 10 AM NZT / 9 PM UTC)
SELECT cron.schedule(
  'daily-incomplete-onboarding-check',
  '0 21 * * *',
  $$
  SELECT net.http_post(
    url := 'https://qermxzepyzbenemcordv.supabase.co/functions/v1/check-incomplete-onboarding',
